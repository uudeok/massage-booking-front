...
export const splitTimeArrays = (timeArrays: string[], timeInterval: number) => {
	...
	timeArrays.forEach((timeArray) => {
		const startTime = new Date(`1970-01-01T${timeArray[0]}:00`);
...
export const isTimeOverlaps = (spreadData: string[], start: string, end: string) => {
...
export const filterTimeRange = (timeList: string[], minTime: string, maxTime: string) => {
