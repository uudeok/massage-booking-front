...
const DateCell = ({ $isToday, dateLabel, disabled, monthName, curMonthOnly, selected, onMouseOver }: IDateCell) => {
	return (
		<Self
			disabled={disabled}
			$month={monthName}
		...
		>
			...
			{$isToday && monthName === MONTH_NAME.CURRENT && <TodayLabel>오늘</TodayLabel>}
		</Self>
	);
};
